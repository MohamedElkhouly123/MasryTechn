...
public class AllNaqlahAdapter extends RecyclerView.Adapter<AllNaqlahAdapter.ViewHolder> {

    private List<GetAllNaqlaResponse.Datum> listData;
    private Context context;
    private Listener listener;

    public AllNaqlahAdapter(List<GetAllNaqlaResponse.Datum> listData, Context context, Listener listener) {
    ...
    @NonNull
    @Override
    public AllNaqlahAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new AllNaqlahAdapter.ViewHolder(LayoutInflater.from(context).
